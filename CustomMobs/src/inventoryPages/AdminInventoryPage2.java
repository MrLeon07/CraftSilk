...
public class AdminInventoryPage2 implements IPage{
	private int PageNumber = 2;
	private Inventory inv;
	Player player;
	private int size = 54;
	private String name = "Admin Items Page 2";
	public AdminInventoryPage2() {
	...
	private void fill() {
		...
		try {
			helmets = database.getAdminCommandItems("chainmail_helmet");
			chestPlates = database.getAdminCommandItems("chainmail_chestplate");
			leggings = database.getAdminCommandItems("chainmail_leggings");
			boots = database.getAdminCommandItems("chainmail_boots");
			swords = database.getAdminCommandItems("stone_sword");
			...
			pagePaperMeta.setDisplayName(ChatColor.GREEN+"Zincir zýrh ve Taþ Kýlýç Modelleri");
