...
public class AdminInventoryPage3 implements IPage{
	private Inventory inv;
	Player player;
	private int PageNumber = 3;
	private int size = 54;
	private String name = "Admin Items Page 3";
	public AdminInventoryPage3() {
	...
	private void fill() {
		...
		try {
			helmets = database.getAdminCommandItems("golden_helmet");
			chestPlates = database.getAdminCommandItems("golden_chestplate");
			leggings = database.getAdminCommandItems("golden_leggings");
			boots = database.getAdminCommandItems("golden_boots");
			swords = database.getAdminCommandItems("golden_sword");
			...
			pagePaperMeta.setDisplayName(ChatColor.GREEN+"Altýn zýrh ve Altýn Kýlýç Modelleri");
