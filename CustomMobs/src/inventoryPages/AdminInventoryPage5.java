...
public class AdminInventoryPage5 implements IPage{
	private Inventory inv;
	Player player;
	private int PageNumber = 5;
	private int size = 54;
	private String name = "Admin Items Page 5";
	public AdminInventoryPage5() {
	...
	private void fill() {
		...
		try {
			helmets = database.getAdminCommandItems("diamond_helmet");
			chestPlates = database.getAdminCommandItems("diamond_chestplate");
			leggings = database.getAdminCommandItems("diamond_leggings");
			boots = database.getAdminCommandItems("diamond_boots");
			swords = database.getAdminCommandItems("diamond_sword");
			...
			pagePaperMeta.setDisplayName(ChatColor.GREEN+"Elmas zýrh ve Elmas Kýlýç Modelleri");
