...
public class Main extends JavaPlugin{
	...
	public void onEnable() {
		...
		registerEntity("Zombie", 54, EntityZombie.class, bossZombie.class);
	...
	public void registerEntity(String name, int id, Class<? extends EntityInsentient> nmsClass, Class<? extends EntityInsentient> customClass) {
		...
		*/
		...
		List<Biome> metaList = (List<Biome>) list.get(f.get(null));
		...
		* custom entity class
		*/
		for (Biome meta : metaList) {
		Field clazz = Biome.class.getDeclaredFields()[0];
